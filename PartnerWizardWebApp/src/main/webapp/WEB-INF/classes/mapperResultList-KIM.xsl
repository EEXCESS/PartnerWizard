...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:edm="http://www.europeana.eu/schemas/edm/" xmlns:wgs84_pos="http://www.w3.org/2003/01/geo/wgs84-pos"
	...
	<xsl:template match="/">
		...
		<xsl:element name="rdf:RDF">
			...
			<xsl:attribute name="xml:base">https://www.kgportal.bl.ch/kim-portal-theme/images/favicon.icoedm/</xsl:attribute>
			...
			<xsl:for-each select="/response/result/doc/">
				...
				<xsl:variable name="mainURI">
			         <xsl:value-of select="concat('https://www.kgportal.bl.ch/sammlungen#',$tempMainURI)" />
				</xsl:variable>
				...
				<xsl:element name="ore:Aggregation">
					...
					<xsl:element name="edm:provider">
						<xsl:element name="edm:Agent">
							<xsl:attribute name="rdf:about">https://www.kgportal.bl.ch/kim-portal-theme/images/favicon.ico</xsl:attribute>
							<xsl:element name="foaf:name">KIMportal PartnerSetupTest</xsl:element>
						</xsl:element>
					</xsl:element>
				...
				<xsl:element name="eexcess:Proxy">
					...
					<xsl:element name="edm:rights">http://creativecommons.org/licenses/by-nc-sa/4.0/</xsl:element>
	...
	<template xmlns="http://www.w3.org/1999/XSL/Transform" match="str[@name='uuid']"
		mode="m0">
		<element name="uri">https://www.kgportal.bl.ch/sammlungen#<call-template name="StringToString" /></element>
	</template>
	...
	<template xmlns="http://www.w3.org/1999/XSL/Transform" match="str[@name='uuid']"
		mode="m3">
		<element name="uri"><call-template name="StringToString" /></element>
	</template>
	...
	<template xmlns="http://www.w3.org/1999/XSL/Transform" match="arr[@name='_thumbs_']"
		mode="m5">
		<element name="edm:preview">
			<attribute name="resource">https://kgapi.bl.ch/<call-template name="StringToString" /></attribute>
		</element>
	</template>
	<template xmlns="http://www.w3.org/1999/XSL/Transform" match="str[@name='_display_']"
		mode="m6">
